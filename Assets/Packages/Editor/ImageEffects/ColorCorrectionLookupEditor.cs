    ...
    class ColorCorrectionLookupEditor : Editor
    {
        ...
        public override void OnInspectorGUI () {
            ...
            if (tex && (target as ColorCorrectionLookup).basedOnTempTex != AssetDatabase.GetAssetPath(tex))
            {
                ...
                {
                    // EDITADO POR SANTI: Acá hice lo mejor que pude con el tema de textureCompression
                    ...
                    if (!textureImporter.textureCompression.Equals("Uncompressed"))
                    {
                        doImport = true;
                    }
                    ...
                    if (doImport)
                    {
                        ...
                        textureImporter.textureCompression.Equals("Uncompressed");
